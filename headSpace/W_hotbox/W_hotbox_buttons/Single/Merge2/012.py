...
for node in selection:
    ...
    ops = node.knob('operation').value()
    lbl = node.knob('label').value()
    bbx = node.knob('bbox').value()
    mx = node.knob('mix').value()
    ...
    newNode.knob('operation').setValue(ops)
    newNode.knob('label').setValue(lbl)
    newNode.knob('disable_group_view').setValue(True)
    newNode.knob('bbox').setValue(bbx)
    newNode.knob('mix').setValue(mx)
