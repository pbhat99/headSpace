"""
Configuration module for KnobScripter.

This module defines directory paths, global preferences, and other configuration values
...
# Global preferences for KnobScripter
prefs = {
    "ks_directory": "KS3",
...
# List of JSON files for the code gallery
code_gallery_files = [CODE_GALLERY_DEFAULT_FILE]
...
py_state_dict = {}  # in-memory storage for Python state
knob_state_dict = {}  # in-memory storage for knob state
