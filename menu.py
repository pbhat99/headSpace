...
import tabtabtab
nuke.menu("Nuke").addCommand('-{ pb }-/TabTabTab', tabtabtab.main, 'Ctrl+Tab', shortcutContext=2, icon='pbicon.png')
...
#Cycle Operations
nuke.menu('Nuke').addCommand('-{ pb }-/Cycle Forwards', "import CycleOperations ; CycleOperations.CycleOperations()", "]", shortcutContext=2, icon='pbicon.png')
nuke.menu('Nuke').addCommand('-{ pb }-/Cycle Backwards', "import CycleOperations ; CycleOperations.CycleOperations(False)", "[", shortcutContext=2, icon='pbicon.png')
